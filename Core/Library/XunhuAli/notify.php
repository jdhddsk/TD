...
if($data['status']=='OD') {
    ...
    $sql = "
        INSERT INTO `wp_gcz_order` (`gcz_id`, `gcz_name`, `gcz_money`, `gcz_order`, `gcz_status`, `gcz_time`, `gcz_user`, `gcz_xunhuid`,`gcz_type`) VALUES (NULL, '".$name."', '".$money."', '".$order."', '1', '".$time."', '0' , ".$xunhuid.",'支付宝支付')
    ";
    $wpdb->query($sql);
    //....
    //...

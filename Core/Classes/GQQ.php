<?php
define('QQ_APPID', get_option('gcz_options')['gcz-qq-field']['gcz-qq-appid']);
define('QQ_APPSECRET', get_option('gcz_options')['gcz-qq-field']['gcz-qq-appsecret']);
...
function qq_oauth_url() {
    $url = "https://graph.qq.com/oauth2.0/authorize?client_id=" . QQ_APPID . "&state=" . md5(uniqid(rand(), true)) . "&response_type=code&redirect_uri=" . urlencode(GCZ_URI.'/Core/Classes/GQQ.php');
    return $url;
}

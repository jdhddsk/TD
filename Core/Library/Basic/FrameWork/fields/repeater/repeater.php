  ...
  class CSF_Field_repeater extends CSF_Fields {
    ...
    public function render() {
      ...
      if( $this->parent && preg_match( '/'. preg_quote( '['. $this->field['id'] .']' ) .'/', $this->parent ) ) {
        ...
        echo '<i class="csf-repeater-sort iconoir-arrow-separate-vertical"></i>';
        echo '<i class="csf-repeater-clone iconoir-copy"></i>';
        echo '<i class="csf-repeater-remove csf-confirm iconoir-cancel" data-confirm="'. esc_html__( 'Are you sure to delete this item?', 'csf' ) .'"></i>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
        ...
        echo '<div class="csf-repeater-alert csf-repeater-max">'. esc_html__( '你不能添加至超过', 'csf' ) .' '. $args['max'] .'</div>';
        echo '<div class="csf-repeater-alert csf-repeater-min">'. esc_html__( '你不能减少至超过', 'csf' ) .' '. $args['min'] .'</div>';
